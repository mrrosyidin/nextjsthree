...
import AddEarlyAccess from "./AddEarlyAccess";
import UpdateEarlyAccess from "./UpdateEarlyAccess";
import DeleteEarlyAccess from "./DeleteEarlyAccess";
...
export default function TableEarlyAccess(data: Data[]) {
                ...
                {filteredData.map((user) => (
                  <tr key={user.id}>
                    ...
                    <td className="flex h-12 px-6 text-sm transition duration-300 border-t border-l first:border-l-0 border-slate-200 stroke-slate-500 text-slate-500 ">
                      <div className="mr-1">
                        <UpdateEarlyAccess {...user}></UpdateEarlyAccess>
                      </div>
                      <DeleteEarlyAccess {...user}></DeleteEarlyAccess>
                    </td>
                  </tr>
                ))}
              </tbody>
